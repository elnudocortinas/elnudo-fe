    ...
    <nav className="bg-white p-4">
      <div className="flex flex-col items-start md:flex-row md:items-center md:justify-around max-w-7xl mx-auto">
        ...
        <ul className={`gap-10 items-center justify-center w-full  md:justify-end  ${isOpen ? 'flex flex-col md:flex-row' : 'hidden md:flex'} `}>
          <li className="font-light">{currentLang.locale.menu.index}</li>
          <li className="font-light">{currentLang.locale.menu.about}</li>
          <li className="font-light">{currentLang.locale.menu.services}</li>
          <li className="font-light">{currentLang.locale.menu.clients}</li>
          <li className="font-light">{currentLang.locale.menu.contact}</li>
